...
/**
 * Funció per controlar el comptador de temps.
 * 
 * @returns {Window.timeCount|Number|window.timeCount|String}
 */
...
/**
 * Funció per carregar el següent nivell del joc.
 * 
 * @returns {undefined}
 */
function nextLevel() {
...
/**
 * Funció per assignar els controladors de drag and drop als objectes del jugador.
 * 
 * @param {type} items Llista de nodes
 * @returns {undefined}
 */
...
/**
 * Funció per assignar els controladors de drag and drop als objectes del joc.
 * 
 * @param {type} items Llista de nodes.
 */
